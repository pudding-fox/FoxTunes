...
namespace FoxTunes
{
    public abstract class SquareConfigurableUIComponentBase : ConfigurableUIComponentBase
    {
        public static readonly DependencyProperty SizeModeProperty = DependencyProperty.Register(
            "SizeMode",
            typeof(SquareUIComponentSizeMode),
            typeof(SquareConfigurableUIComponentBase),
            new FrameworkPropertyMetadata(SquareUIComponentSizeMode.ToHeight, new PropertyChangedCallback(OnSizeModeChanged))
        );

        public static SquareUIComponentSizeMode GetSizeMode(SquareConfigurableUIComponentBase source)
        {
            return (SquareUIComponentSizeMode)source.GetValue(SizeModeProperty);
        }

        public static void SetSizeMode(SquareConfigurableUIComponentBase source, SquareUIComponentSizeMode value)
        {
        ...
        {
            var squareConfigurableUIComponentBase = sender as SquareConfigurableUIComponentBase;
            if (squareConfigurableUIComponentBase == null)
            {
                return;
            }
            squareConfigurableUIComponentBase.OnSizeModeChanged();
        }
