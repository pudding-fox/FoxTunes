...
The main release is [FoxTunes-3.5.0-net48.zip](https://github.com/pudding-fox/FoxTunes/releases/download/3.5.0/FoxTunes-3.5.0-net48.zip).  
For additional plugins, download [FoxTunes-3.5.0-Plugins-net48.zip](https://github.com/pudding-fox/FoxTunes/releases/download/3.5.0/FoxTunes-3.5.0-Plugins-net48.zip) (extract and copy required folders to the FoxTunes\lib directory).
