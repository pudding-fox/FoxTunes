...
The main release is [FoxTunes-2.7.4-net462.zip](https://github.com/Raimusoft/FoxTunes/releases/download/2.7.4/FoxTunes-2.7.4-net462.zip).  
For additional plugins, download [FoxTunes-2.7.4-Plugins-net462.zip](https://github.com/Raimusoft/FoxTunes/releases/download/2.7.4/FoxTunes-2.7.4-Plugins-net462.zip) (extract and copy required folders to the FoxTunes\lib directory).
