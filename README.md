...
The main release is [FoxTunes-3.3.1-net48.zip](https://github.com/pudding-fox/FoxTunes/releases/download/3.3.1/FoxTunes-3.3.1-net48.zip).  
For additional plugins, download [FoxTunes-3.3.1-Plugins-net48.zip](https://github.com/pudding-fox/FoxTunes/releases/download/3.3.1/FoxTunes-3.3.1-Plugins-net48.zip) (extract and copy required folders to the FoxTunes\lib directory).
