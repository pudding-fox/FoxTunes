...
The main release is [FoxTunes-3.0.6-net462.zip](https://github.com/Raimusoft/FoxTunes/releases/download/3.0.6/FoxTunes-3.0.6-net462.zip).  
For additional plugins, download [FoxTunes-3.0.6-Plugins-net462.zip](https://github.com/Raimusoft/FoxTunes/releases/download/3.0.6/FoxTunes-3.0.6-Plugins-net462.zip) (extract and copy required folders to the FoxTunes\lib directory).
