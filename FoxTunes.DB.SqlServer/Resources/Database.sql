...
INSERT INTO "PlaylistColumns" (Id,Sequence,Name,DisplayScript,IsDynamic,Width) VALUES (2,1,'Artist / album','(function(){ var parts = [tag.firstalbumartist || tag.firstalbumartistsort || tag.firstartist]; if(tag.album) { parts.push(tag.album); } return parts.join(" - "); })()',0,NULL);
