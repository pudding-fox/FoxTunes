...
_CRT_INSECURE_DEPRECATE(_strnset_s_l) __inline char * __CRTDECL _strnset_l(__inout_z char *_Destination, __in int _Value, __in size_t _Count, __in_opt _locale_t _Locale)
{
    _CRT_UNUSED(_Locale);
#pragma warning( push )
#pragma warning( disable : 4996 )
