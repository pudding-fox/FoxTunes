...
_CRTIMP _CRT_INSECURE_DEPRECATE_CORE(_mbscat_s) unsigned char * __cdecl _mbscat(__inout_z unsigned char *, __in_z const unsigned char *);
...
_CRTIMP _CRT_INSECURE_DEPRECATE_CORE(_mbscpy_s) unsigned char * __cdecl _mbscpy(__out_z unsigned char *, __in_z const unsigned char *);
...
_CRTIMP _CRT_INSECURE_DEPRECATE_CORE(_mbsncat_s) unsigned char * __cdecl _mbsncat(__inout_z unsigned char *, __in_z const unsigned char *, size_t);
