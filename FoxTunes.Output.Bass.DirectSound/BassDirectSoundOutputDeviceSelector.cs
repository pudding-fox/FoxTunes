...
namespace FoxTunes
{
    ...
    public class BassDirectSoundOutputDeviceSelector : BassOutputDeviceSelector
    {
        ...
        public override bool IsActive
        {
            get
            {
                return string.Equals(this.OutputElement.Value.Id, BassDirectSoundStreamOutputConfiguration.OUTPUT_DS_OPTION, StringComparison.OrdinalIgnoreCase);
            }
            set
            {
                if (!value)
                ...
                var output = this.OutputElement.GetOption(BassDirectSoundStreamOutputConfiguration.OUTPUT_DS_OPTION);
                if (output == null)
                {
                    return;
                }
        ...
        {
            this.DeviceElement.WithOptions(BassDirectSoundStreamOutputConfiguration.GetDSDevices(), true);
