    ...
    public static class PicardConfiguration
    {
        ...
        public static IEnumerable<ConfigurationSection> GetConfigurationSections()
        {
            yield return new ConfigurationSection(SECTION, "Tools")
                .WithElement(new BooleanConfigurationElement(ENABLED_ELEMENT, "Enabled", path: "MusicBrainz Picard").WithValue(false))
                .WithElement(new TextConfigurationElement(PATH_ELEMENT, "Path", path: "MusicBrainz Picard").WithValue("C:\\Program Files\\MusicBrainz Picard\\picard.exe").WithFlags(ConfigurationElementFlags.FileName)
            );
