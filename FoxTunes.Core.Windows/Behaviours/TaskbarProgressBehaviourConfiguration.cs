    ...
    public static class TaskbarProgressBehaviourConfiguration
    {
        ...
        public static IEnumerable<ConfigurationSection> GetConfigurationSections()
        {
                ...
                yield return new ConfigurationSection(SECTION, Strings.WindowsConfiguration_Section)
                    .WithElement(new BooleanConfigurationElement(ENABLED_ELEMENT, Strings.TaskbarProgressBehaviourConfiguration_Enabled).WithValue(releaseType == ReleaseType.Default)
                );
        }
    }
}
