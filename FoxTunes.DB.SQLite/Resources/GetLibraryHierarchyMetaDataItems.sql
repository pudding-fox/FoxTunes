SELECT "MetaDataItems"."Id", "MetaDataItems"."Name", "MetaDataItems"."Type", "MetaDataItems"."NumericValue",  "MetaDataItems"."TextValue", "MetaDataItems"."FileValue"
...
GROUP BY "MetaDataItems"."Id", "MetaDataItems"."Name", "MetaDataItems"."Type", "MetaDataItems"."NumericValue",  "MetaDataItems"."TextValue", "MetaDataItems"."FileValue"