...
namespace FoxTunes
{
    public static class CommonMetaData
    {
        ...
        public const string FirstAlbumArtistSort = "FirstAlbumArtistSort";
        public const string FirstArtist = "FirstArtist";
        public const string FirstComposer = "FirstComposer";
        public const string FirstComposerSort = "FirstComposerSort";
        public const string FirstGenre = "FirstGenre";
        public const string FirstPerformer = "FirstPerformer";
        public const string FirstPerformerSort = "FirstPerformerSort";
        public const string Genres = "Genres";
        public const string Grouping = "Grouping";
        public const string JoinedAlbumArtists = "JoinedAlbumArtists";
        public const string JoinedArtists = "JoinedArtists";
        public const string JoinedComposers = "JoinedComposers";
        public const string JoinedGenres = "JoinedGenres";
        public const string JoinedPerformers = "JoinedPerformers";
        public const string JoinedPerformersSort = "JoinedPerformersSort";
