...
namespace FoxTunes
{
    ...
    public class BassAsioOutputDeviceSelector : BassOutputDeviceSelector
    {
        ...
        public override bool IsActive
        {
            get
            {
                return string.Equals(this.OutputElement.Value.Id, BassAsioStreamOutputConfiguration.OUTPUT_ASIO_OPTION, StringComparison.OrdinalIgnoreCase);
            }
            set
            {
                if (!value)
                ...
                var output = this.OutputElement.GetOption(BassAsioStreamOutputConfiguration.OUTPUT_ASIO_OPTION);
                if (output == null)
                {
                    return;
                }
        ...
        {
            this.DeviceElement.WithOptions(BassAsioStreamOutputConfiguration.GetASIODevices(), true);
